...
// Timers. Everything else can vector to an error handling ISR.
//
//###########################################################################
...
const struct PIE_VECT_TABLE PieVectTableInit = {
    ...
    rsvd_ISR,                                 // 5.4 - Reserved
    rsvd_ISR,                                 // 5.5 - Reserved
    rsvd_ISR,                                 // 5.6 - Reserved
    rsvd_ISR,                                 // 5.7 - Reserved
    rsvd_ISR,                                 // 5.8 - Reserved
    ...
    rsvd_ISR,                                 // 7.7 - Reserved
    rsvd_ISR,                                 // 7.8 - Reserved
    ...
    rsvd_ISR,                                 // 12.4 - Reserved
    rsvd_ISR,                                 // 12.5 - Reserved
    rsvd_ISR,                                 // 12.6 - VCU Interrupt
    rsvd_ISR,                                 // 12.7 - FPU Overflow Interrupt
    rsvd_ISR,                                 // 12.8 - FPU Underflow Interrupt
    rsvd_ISR,                                 // 1.9 - Reserved
    rsvd_ISR,                                 // 1.10 - Reserved
    rsvd_ISR,                                 // 1.11 - Reserved
    rsvd_ISR,                                 // 1.12 - Reserved
    ...
    rsvd_ISR,                                 // 2.13 - Reserved
    rsvd_ISR,                                 // 2.14 - Reserved
    rsvd_ISR,                                 // 2.15 - Reserved
    rsvd_ISR,                                 // 2.16 - Reserved
    rsvd_ISR,                                 // 3.9 - ePWM9 Interrupt
    rsvd_ISR,                                 // 3.10 - ePWM10 Interrupt
    rsvd_ISR,                                 // 3.11 - ePWM11 Interrupt
    rsvd_ISR,                                 // 3.12 - ePWM12 Interrupt
    rsvd_ISR,                                 // 3.13 - Reserved
    rsvd_ISR,                                 // 3.14 - Reserved
    rsvd_ISR,                                 // 3.15 - Reserved
    rsvd_ISR,                                 // 3.16 - Reserved
    rsvd_ISR,                                 // 4.9 - Reserved
    rsvd_ISR,                                 // 4.10 - Reserved
    rsvd_ISR,                                 // 4.11 - Reserved
    rsvd_ISR,                                 // 4.12 - Reserved
    rsvd_ISR,                                 // 4.13 - Reserved
    rsvd_ISR,                                 // 4.14 - Reserved
    rsvd_ISR,                                 // 4.15 - Reserved
    rsvd_ISR,                                 // 4.16 - Reserved
    rsvd_ISR,                                 // 5.9 - SD1 Interrupt
    rsvd_ISR,                                 // 5.10 - SD2 Interrupt
    rsvd_ISR,                                 // 5.11 - Reserved
    rsvd_ISR,                                 // 5.12 - Reserved
    rsvd_ISR,                                 // 5.13 - Reserved
    rsvd_ISR,                                 // 5.14 - Reserved
    rsvd_ISR,                                 // 5.15 - Reserved
    rsvd_ISR,                                 // 5.16 - Reserved
    rsvd_ISR,                                 // 6.9 - SPIC Receive Interrupt
    rsvd_ISR,                                 // 6.10 - SPIC Transmit Interrupt
    rsvd_ISR,                                 // 6.11 - Reserved
    rsvd_ISR,                                 // 6.12 - Reserved
    rsvd_ISR,                                 // 6.13 - Reserved
    rsvd_ISR,                                 // 6.14 - Reserved
    rsvd_ISR,                                 // 6.15 - Reserved
    rsvd_ISR,                                 // 6.16 - Reserved
    rsvd_ISR,                                 // 7.9 - Reserved
    rsvd_ISR,                                 // 7.10 - Reserved
    rsvd_ISR,                                 // 7.11 - Reserved
    rsvd_ISR,                                 // 7.12 - Reserved
    rsvd_ISR,                                 // 7.13 - Reserved
    rsvd_ISR,                                 // 7.14 - Reserved
    rsvd_ISR,                                 // 7.15 - Reserved
    rsvd_ISR,                                 // 7.16 - Reserved
    rsvd_ISR,                                 // 8.9 - Reserved
    rsvd_ISR,                                 // 8.10 - Reserved
    rsvd_ISR,                                 // 8.11 - Reserved
    rsvd_ISR,                                 // 8.12 - Reserved
    rsvd_ISR,                                 // 8.13 - Reserved
    rsvd_ISR,                                 // 8.14 - Reserved
    rsvd_ISR,                                 // 8.15 - uPPA Interrupt
    rsvd_ISR,                                 // 8.16 - Reserved
    rsvd_ISR,                                 // 9.9 - Reserved
    rsvd_ISR,                                 // 9.10 - Reserved
    rsvd_ISR,                                 // 9.11 - Reserved
    rsvd_ISR,                                 // 9.12 - Reserved
    rsvd_ISR,                                 // 9.13 - Reserved
    rsvd_ISR,                                 // 9.14 - Reserved
    rsvd_ISR,                                 // 9.15 - USBA Interrupt
    rsvd_ISR,                                 // 9.16 - Reserved
    ...
    rsvd_ISR,                                 // 11.9 - Reserved
    rsvd_ISR,                                 // 11.10 - Reserved
    rsvd_ISR,                                 // 11.11 - Reserved
    rsvd_ISR,                                 // 11.12 - Reserved
    rsvd_ISR,                                 // 11.13 - Reserved
    rsvd_ISR,                                 // 11.14 - Reserved
    rsvd_ISR,                                 // 11.15 - Reserved
    rsvd_ISR,                                 // 11.16 - Reserved
...
//Stuff from PieCtrl - not sure it's needed
    //
    // Enable the PIE
    //
